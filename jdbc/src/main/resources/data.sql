...
insert into author(`name`) values ('Чехов А.П.');
insert into author(`name`) values ('Горький Максим');

insert into genre(`name`) values ('Роман');
insert into genre(`name`) values ('Классика');
insert into genre(`name`) values ('Детектив');
insert into genre(`name`) values ('Сборник');

insert into book(id,`name`) values (1,'Война и мир');
insert into book(id,`name`) values (2,'На дне');
insert into book(id,`name`) values (3,'Анна Каренина');
insert into book(id,`name`) values (4,'Сборник рассказов и повестей');
